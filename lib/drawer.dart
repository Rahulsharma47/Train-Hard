...
class MenuScreen extends StatelessWidget {
  ...
  Widget _buildMenuItems(BuildContext context) {
    return ListView(
      children: [
        ...
        _buildDrawerItem(context, 'Share', FontAwesomeIcons.shareNodes, _showDevelopmentPopup),
        _buildDrawerItem(context, 'Log Out', FontAwesomeIcons.rightFromBracket, _logOut),
      ],
    );
  }
  ...
  Widget _buildDrawerItem(BuildContext context, String title, IconData icon, Function(BuildContext) onTap) {
    return ListTile(
      leading: FaIcon(icon, color: Colors.white70, size: 22),
      title: Text(
        title,
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: const Text("Feature in Development", style: TextStyle(color: Colors.white)),
          content: const Text(
          ...
          actions: [
            TextButton(
              ...
              child: const Text("OK", style: TextStyle(color: Color(0xffbb0a1e))),
            ),
          ],
        );
      },
...
// Define SubMenuItem class to prevent errors
class SubMenuItem {
  final String title;
